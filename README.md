...
- <имя операции>() – необходимо выполнить операцию над объектом формы. Поддерживаются следующие операции:
  ...
  - СписокВыбора - в ячейке через запятую указывается список предопределенных элементов для ссылочных типов или значений для примитивных, которые будут добавлены в список выбора элемента
