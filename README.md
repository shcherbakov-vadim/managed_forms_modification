...
Подсистема предназначения для ограничения измененения реквизитов управляемой формы на основании других реквизитов. Разные ограничивать доступ к реквизитам в зависимости от статусов или функциональных ролей

Ограничение выполняется с помощью вызова
```bsl
...
При необходимости восстановить ограничение доступа, измененное, например, в обработчиках разрешенных для редактирования реквизитов необходимо выполнить
```bsl
МодификацияУправляемыхФорм.ВосстановитьОграничениеИзмененияРеквизитов(ЭтаФорма, "Утвержден")
```
Для отмены ограничения доступа необходимо выполнить
```bsl
