...
```
В качестве МакетаИзменений рекомендуется указывать полный путь к общему макету или макету объекта метаданных. В этом случае он будет доступен для редактирования с помощью расширения
...
<img width="2045" height="1168" alt="2026-01-03_19-28-48" src="https://github.com/user-attachments/assets/f45651be-2b68-46cc-a7b2-5c7f3080463b" />
