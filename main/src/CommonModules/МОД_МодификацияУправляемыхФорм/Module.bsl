...
Процедура ПрименитьШаблон(ПараметрыОбработки, ТипШаблона, ТекстВызова, ИмяРодителя = Неопределено)
	...
	Если ТипШаблона = "Элементы" Тогда
		ИзменитьЭлементы(ПараметрыОбработкиШаблона, ПолучитьРаздел(ПараметрыОбработки.ДанныеМакета, ИмяОбласти), , , , ИмяРодителя);
	ИначеЕсли ТипШаблона = "Реквизиты" Тогда
		ИзменитьРеквизиты(ПараметрыОбработкиШаблона, ПолучитьРаздел(ПараметрыОбработки.ДанныеМакета, ИмяОбласти), , , , ИмяРодителя);
	ИначеЕсли ТипШаблона = "Команды" Тогда
		ИзменитьКоманды(ПараметрыОбработкиШаблона, ПолучитьРаздел(ПараметрыОбработки.ДанныеМакета, ИмяОбласти));
	КонецЕсли;
КонецПроцедуры
